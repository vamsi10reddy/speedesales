# Generated by Django 5.1.2 on 2024-11-18 07:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Speed-e-sales-products', max_length=100)),
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=8, max_length=10, prefix='sku', unique=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='I am the best vendor', null=True)),
                ('address', models.CharField(default='Lubbock Main Street, Texas', max_length=100)),
